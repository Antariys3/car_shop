    ...
    if form.is_valid():
        ...
        for car_type in form.car_types:
            ...
            if quantity > 0:
                ...
                cars_to_reserve = Car.objects.filter(car_type__name=car_type_obj.name, blocked_by_order=None)[:quantity]
...
def order_edit(request, pk):
    teacher = Order.objects.get(pk=pk)
    return render(request, "order_edit.html", {"form": teacher})
